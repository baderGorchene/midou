...
namespace PFE.Infrastructure.Migrations
{
    ...
    [Migration("20260508133755_AddImageUrlToAnnouncements")]
    partial class AddImageUrlToAnnouncements
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PFE.Domain.Entities.DepartmentChannelReadState", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("DepartmentChannelReadStates");
                });
            ...
            modelBuilder.Entity("PFE.Domain.Entities.DepartmentChannelReadState", b =>
                {
                    ...
                    b.HasOne("PFE.Domain.Entities.User", "User")
                        .WithMany("DepartmentChannelReadStates")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PFE.Domain.Entities.RoomReservation", b =>
                {
                    ...
                    b.HasOne("PFE.Domain.Entities.User", "EndedBy")
                        .WithMany()
                    ...
                    b.HasOne("PFE.Domain.Entities.User", "StartedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("PFE.Domain.Entities.User", b =>
                {
                    ...
                    b.Navigation("DepartmentChannelReadStates");
